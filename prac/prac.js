document.addEventListener('DOMContentLoaded', function() {
  ...
  function initResize(e) {
    ...
    var startWidth = parseInt(document.defaultView.getComputedStyle(resizableElement).width, 10);
    var startHeight = parseInt(document.defaultView.getComputedStyle(resizableElement).height, 10);
